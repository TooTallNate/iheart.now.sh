...
export default class Input extends React.Component {
  ...
  render() {
    ...
    const textIndent = this.state.baseWidth != null
      ? this.state.baseWidth
      : null;
    ...
    return (
      ...
      >
        ...
        <style jsx>
          ...
          div.error, div.error.focused.light {
            border-bottom-color: #FF001F;
          }

          div.waiting, div.waiting.focused.light {
            border-bottom-color: #eee;
          }

          input, .clone {
            /* use 'font' to redefine line-height */
            font: 16px ${FONT_FAMILY_SANS};
            height: 18px;
          }
